# -*- coding: utf-8 -*-
# @Author: chetan
# @Date:   2021-01-08 00:38:20
# @Last Modified by:   chetan
# @Last Modified time: 2021-01-08 00:53:33

'''
Downloads data and extracts
'''
    ...
    for file in files:
    	...
    	if not os.path.exists(file_name):
    		with TqdmUpTo(unit = 'B', unit_scale=True, miniters=1, desc=link.split('/')[-1]) as t:
    			urllib.request.urlretrieve(link, file_name, reporthook=t.update_to, data=None)
